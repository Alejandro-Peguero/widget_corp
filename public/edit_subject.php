...
<?php
   if (isset($_POST['submit'])) {
       ...
       //($result && mysqli_affected_rows($connection) == 1)da error si al modificar se dejan los valores iguales
...
<?php include("../includes/layouts/header.php"); ?>
        ...
        <div id="main">
          ...
          <div id="page">
            <!--this message is just a local variable, does not use the session---->
